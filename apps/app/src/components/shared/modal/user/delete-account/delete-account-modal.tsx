...
import { clearAllUserData } from '@/actions/user/clear-data';
            ...
            >
                <DialogHeader className="sr-only">
                    ...
                    <DialogDescription id="delete-account-description" className="text-left">
                        This action is not reversible. Firescrape will delete all of your data and scraping history.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="space-y-3 text-sm text-muted-foreground">
                        <p>
                            Firescrape will <strong>delete all of your scraping data</strong>, along with all of
                            your saved runs, API keys, preferences, and all other
                            data associated with your account.
                        </p>
                        <p>
                            Firescrape recommends that you export any scraping data you wish to keep before
