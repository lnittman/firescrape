...
export default function AccountLayout({ children }: AccountLayoutProps) {
    ...
    return (
        <ViewTransitions>
            <div className="flex justify-center min-h-[calc(100vh-104px)]">
                <div className="relative flex w-full max-w-6xl">
                    {/* Account Sidebar - shared across account overview pages */}
                    <div className="hidden sm:block sticky top-[104px] left-0 h-[calc(100vh-104px)] w-72 bg-background/50 backdrop-blur-xl">
